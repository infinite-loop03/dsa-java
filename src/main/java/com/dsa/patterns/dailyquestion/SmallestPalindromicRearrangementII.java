...
public class SmallestPalindromicRearrangementII {
    ...
    public static void main(String[] args) {
        SmallestPalindromicRearrangementII smallestPalindromicRearrangementII = new SmallestPalindromicRearrangementII();
        System.out.println(smallestPalindromicRearrangementII.smallestPalindrome("abba", 2));
    }
